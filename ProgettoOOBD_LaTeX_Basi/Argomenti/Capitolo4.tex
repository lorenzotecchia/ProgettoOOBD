...
\footnote{\href{https://github.com/lorenzotecchia/ProgettoOOBD/blob/main/BD/Documentazione/DocumentazioneCodiceSQL.md#documentazione-codice-sql}{[1]}Documentazione del codice SQL}}
\begin{lstlisting}
...
\end{lstlisting}
\footnote{\href{https://github.com/lorenzotecchia/ProgettoOOBD/blob/main/BD/Documentazione/DocumentazioneCodiceSQL.md#documentazione-del-file-tablecreationsql}{[2]}Documentaizone per la creazione delle tabelle}
...
\end{lstlisting}
\footnote{\href{https://github.com/lorenzotecchia/ProgettoOOBD/blob/main/BD/Documentazione/DocumentazioneCodiceSQL.md#documentazione-del-file-functions_triggerssql}{[5]}Documentazione per la creazione di funzioni e trigger}